...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Captura-Estudios" },
      { name: "description", content: "Landing pages estratégicas diseñadas para maximizar ventas y convertir visitas en clientes." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Captura-Estudios" },
      { property: "og:description", content: "Landing pages estratégicas diseñadas para maximizar ventas y convertir visitas en clientes." },
